...
public class GameView {
    ...
    public GameView(int gridSize) {
        ...
        rulesBtn = buildButton("ⓘ RULES", TEXT_MAIN); // Folosim albastrul deschis
        ...
        HBox bottomBox = new HBox(10, rulesBtn, undoBtn, restartBtn, hintBtn, autoStepBtn, targetBtn);
        ...
        try {
            ...
            System.out.println("Nu s-au gasit fisierele audio!");
        }
    }
    ...
    public void bindController(GameController controller) {
        ...
        rulesBtn.setOnAction(e -> controller.showRules());
